...
{
    public class NodeListServerNetworkManager : NetworkRoomManager
    {
        #region Unity Callbacks
        public NodeListServerAdapter nodeListServerAdapter;
        ...
        {
            nodeListServerAdapter.CurrentServerInfo.PlayerCount--;
            nodeListServerAdapter.UpdateServer();
